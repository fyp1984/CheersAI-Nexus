...
public class UserServiceImpl implements UserService {
    ...
    public ResetPasswordResponseDTO resetPassword(String userId) {
        User user = requireUser(userId);
        String defaultPassword = betaProvisioningService.getDefaultPassword();
        String ssoUsername = betaProvisioningService.resetProvisionedPassword(user, defaultPassword);
